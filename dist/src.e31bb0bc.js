...
var model = exports.model = [new _blocks.TitleBlock('Quizlet-Killer', {
  tag: 'h2',
  styles: {
...
new _blocks.ColumnsBlock(['посмотреть свои курсы', 'создать тест', 'мои тесты', 'написать в поддержку'], {
  styles: {
...
var site = new _site.Site('#site'); // dom model

site.render(_model.model); // html -> dom-tree
